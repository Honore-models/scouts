...
export const products: Product[] = [
  {
    ...
    category: "SaaS",
    description:
      "FlowBoard is a next-generation whiteboard that uses AI to help teams brainstorm, plan, and build together. With real-time collaboration, smart suggestions, and an infinite canvas, it makes teamwork effortless.",
    website: "https://flowboard.dev",
    github: "https://github.com/davidkim/flowboard",
    features: [
      {
        title: "AI Powered assistance",
        desc: "Get smart suggestions, auto generate diagrams, and improve your workflow",
      },
      {
        title: "Real time collaboration",
        desc: "Work together with your team in real time with cursors, comments and voice chat",
      },
      {
        title: "Infinite canvas",
        desc: "No limits — create, connect and visualize your ideas freely",
      },
      {
        title: "Multiple templates",
        desc: "Use ready made templates for flowcharts, mind maps, wireframes and more",
      },
      {
        title: "Export & integrations",
        desc: "Export to PDF, SVG, or integrate with your favorite tools",
      },
    ],
    techStack: [
  ...
  },
  {
    ...
    category: "Web Apps",
    description:
      "DeliciousFood is a comprehensive restaurant management platform that streamlines operations from the kitchen to the customer's door. Manage orders, inventory, and delivery all in one place.",
    features: [
      {
      ...
      },
      {
        ...
        desc: "Live GPS tracking for all deliveries with customer notifications",
      },
      {
        title: "Inventory control",
        desc: "Automatic stock alerts and ingredient tracking",
      },
      {
        title: "Analytics dashboard",
        desc: "Insights into sales, peak hours, and popular menu items",
      },
    ],
    techStack: [
      { name: "React", icon: "⚛️", color: "#61DAFB" },
  ...
  },
  {
    ...
    description:
      "CodeSnap lets you create beautiful, shareable code screenshots in seconds. Choose from dozens of themes, customize backgrounds, and export in high resolution.",
    features: [
      {
        title: "Multiple themes",
        desc: "Over 20 beautifully designed themes for your code screenshots",
      },
      {
        title: "Syntax highlighting",
        desc: "Support for 50+ programming languages",
      },
      {
        title: "Custom backgrounds",
        desc: "Choose from gradients, patterns, or upload your own",
      },
      {
        title: "One-click export",
        desc: "Export as PNG, SVG, or copy to clipboard",
      },
    ],
    techStack: [
      { name: "TypeScript", icon: "TS", color: "#3178C6" },
  ...
  },
  {
    ...
    description:
      "Kartz is a marketplace built specifically for independent artists to sell their artwork. With beautiful galleries, secure payments, and artist-friendly tools, it's the perfect platform to showcase your creativity.",
    features: [
      {
        title: "Artist galleries",
        desc: "Beautiful portfolio pages to showcase your work",
      },
      {
        title: "Secure payments",
        desc: "Integrated payment processing with instant payouts",
      },
      {
        title: "Print on demand",
        desc: "Automatic print fulfillment for physical products",
      },
      {
        title: "Social sharing",
        desc: "Built-in tools to share your work across social media",
      },
    ],
    techStack: [
  ...
  },
  {
    ...
    category: "Developer tools",
    description:
      "ShipFast is a boilerplate and toolkit that helps founders launch their MVP in record time. Includes auth, payments, landing pages, and more — all pre-built and ready to customize.",
    features: [
      {
        title: "Pre-built components",
        desc: "Auth, payments, email, and more — all ready to go",
      },
      {
        title: "Landing page templates",
        desc: "High-converting templates optimized for launches",
      },
      {
        title: "Database setup",
        desc: "Pre-configured database with migrations and seed data",
      },
      {
        title: "Deployment guides",
        desc: "Step-by-step guides for Vercel, Railway, and more",
      },
    ],
    techStack: [
      { name: "Next.js", icon: "▲", color: "#111111" },
  ...
  },
  {
    ...
    category: "AI",
    description:
      "MindMap AI uses artificial intelligence to help you brainstorm and organize your thoughts. Simply type an idea and watch as the AI generates connected concepts, suggestions, and visual mind maps.",
    features: [
      {
        title: "AI brainstorming",
        desc: "Type an idea and let AI generate connected concepts",
      },
      {
        title: "Visual mind maps",
        desc: "Automatic visual layouts that make complex ideas simple",
      },
  ...
  },
  {
    ...
    category: "Design",
    description:
      "LandingKit provides a library of beautifully designed, conversion-optimized landing page templates. Customize with a visual editor or code directly — every template is built with modern best practices.",
    features: [
      {
        title: "50+ templates",
        desc: "A growing library of conversion-optimized designs",
      },
      {
        title: "Visual editor",
        desc: "Customize colors, fonts, and layouts without code",
      },
      {
        title: "SEO optimized",
        desc: "Built-in meta tags, Open Graph, and schema markup",
      },
  ...
  },
  {
    ...
    category: "SaaS",
    description:
      "DataPulse gives SaaS founders real-time insights into their product metrics. Track MRR, churn, user engagement, and more with a beautiful, customizable dashboard.",
    features: [
      {
        title: "Real-time metrics",
        desc: "Watch your numbers update in real time",
      },
      {
        title: "Custom dashboards",
        desc: "Build dashboards tailored to your business",
      },
      {
        title: "Automated reports",
        desc: "Get weekly email summaries of key metrics",
      },
      {
        title: "Integrations",
        desc: "Connect Stripe, Segment, Mixpanel, and more",
      },
    ],
    techStack: [
      { name: "React", icon: "⚛️", color: "#61DAFB" },
  ...
  },
  {
    ...
    category: "AI",
    description:
      "PixelForge is an AI-powered image generation and editing platform. Create stunning visuals from text prompts, edit existing images, and build a library of brand assets — all powered by cutting-edge AI.",
    features: [
      {
        title: "Text-to-image",
        desc: "Generate images from natural language descriptions",
      },
      {
        title: "Image editing",
        desc: "AI-assisted editing tools for quick adjustments",
      },
      { title: "Style transfer", desc: "Apply artistic styles to any image" },
      {
        title: "Brand kit",
        desc: "Save and reuse brand colors, fonts, and styles",
      },
    ],
    techStack: [
      { name: "Python", icon: "🐍", color: "#3776AB" },
...
export const feedbackItems: FeedbackItem[] = [
  {
    ...
    type: "suggestion",
    message:
      "It would be great to have a dark mode option for the canvas. Working late at night with a bright background is tiring.",
    time: "2 hours ago",
    upvotes: 24,
    replies: 3,
    responded: true,
  },
  {
    ...
    type: "praise",
    message:
      "Absolutely love the real-time collaboration feature! The cursor tracking is super smooth and the AI suggestions are spot on.",
    time: "5 hours ago",
    upvotes: 18,
    replies: 1,
    responded: false,
  },
  {
    ...
    type: "bug",
    message:
      "The deployment step seems to hang when deploying to Vercel. It works fine on Netlify though. Any ideas?",
    time: "1 day ago",
    upvotes: 12,
    replies: 5,
    responded: true,
  },
  {
    ...
    type: "suggestion",
    message:
      "Could you add support for more programming languages? I mainly use Rust and Go, and the syntax highlighting is missing for those.",
    time: "2 days ago",
    upvotes: 9,
    replies: 2,
    responded: false,
  },
  {
    ...
    type: "question",
    message:
      "Is there a plan to support mobile editing? Would love to make quick edits from my phone.",
    time: "3 days ago",
    upvotes: 15,
    replies: 4,
    responded: true,
  },
  {
    ...
    type: "praise",
    message:
      "This saved me weeks of work! The template system is incredibly well thought out. Highly recommend to any founder.",
    time: "5 days ago",
    upvotes: 31,
    replies: 2,
    responded: false,
...
export const productComments: Record<string, Comment[]> = {
  "1": [
    ...
    },
    {
      ...
      avatar: "MC",
      time: "5h ago",
      text: "Just tried it out. The infinite canvas feature is a game changer for brainstorming sessions.",
      likes: 8,
    },
  ],
  "2": [
    {
      ...
      avatar: "AP",
      time: "1h ago",
      text: "The delivery tracking feature is incredibly detailed. Love the real-time GPS integration!",
      likes: 6,
    },
  ],
  "3": [
    {
      ...
      avatar: "EW",
      time: "3h ago",
      text: "Best code screenshot tool I've used. The themes are gorgeous and export quality is perfect.",
      likes: 15,
    },
    {
      id: 5,
      ...
      avatar: "DK",
      time: "8h ago",
      text: "Would love to see more language support. Otherwise, this is perfect for documentation!",
      likes: 4,
    },
  ],
};
