      ...
      <div className="mx-auto flex min-h-screen max-w-[1320px] items-center justify-center px-5 py-10 sm:px-8 lg:justify-between">
          ...
          <div className="mt-8 rounded-2xl bg-white/70 p-5 shadow-[0_8px_30px_rgba(0,0,0,0.08)] backdrop-blur-sm">
            ...
            <div className="mt-3 flex gap-2.5">
              <div className="flex-1 rounded-xl border border-black/[0.05] bg-white px-3 py-2.5 text-center">
                <p className="flex items-center justify-center gap-1 text-[10px] text-[#999]"><Heart className="h-2.5 w-2.5" /> Likes</p>
                <p className="text-[14px] font-bold text-[#111]">842</p>
              </div>
              <div className="flex-1 rounded-xl border border-black/[0.05] bg-white px-3 py-2.5 text-center">
                <p className="flex items-center justify-center gap-1 text-[10px] text-[#999]"><MessageSquare className="h-2.5 w-2.5" /> Comments</p>
                <p className="text-[14px] font-bold text-[#111]">128</p>
              </div>
              <div className="flex-1 rounded-xl border border-black/[0.05] bg-white px-3 py-2.5 text-center">
                <p className="flex items-center justify-center gap-1 text-[10px] text-[#999]"><TrendingUp className="h-2.5 w-2.5" /> Upvotes</p>
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="rounded-2xl bg-white/80 px-8 py-9 shadow-[0_8px_30px_rgba(0,0,0,0.06)] backdrop-blur-md">
            {/* Header */}
            <h2 className="text-[24px] font-bold text-[#111]">Create your account</h2>
            <p className="mt-1.5 text-[14px] text-[#666]">Start your journey with Scoutts</p>
            ...
            <div className="space-y-4">
              {/* Full name */}
              <div>
                <label htmlFor="fullName" className="mb-1.5 block text-[13px] font-medium text-[#333]">
                  Full name
                </label>
                <div className="relative">
                  ...
                  />
                  <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[#999]"><User className="h-4 w-4" /></span>
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[#999]"><Mail className="h-4 w-4" /></span>
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[#999]"><Lock className="h-4 w-4" /></span>
                </div>
            ...
            <p className="mt-5 text-center text-[13px] text-[#666]">
              ...
              <Link href="/login" className="font-medium text-[#315BFF] hover:underline">
                Log in
              </Link>
            </p>
          </div>
