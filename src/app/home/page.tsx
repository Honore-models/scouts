            ...
            <main className="px-6 py-6">
                ...
                <div>
                  <h1 className="text-[28px] font-bold text-[#111]">
                    ...
                    <span className="inline-block" role="img" aria-label="wave">
                      ...
                      >
                        <path
                          d="M7 15.5c.83.83 2.17.83 3 0 1.66-1.66 1.66-4.34 0-6-1.66-1.66-4.34-1.66-6 0-.83.83-.83 2.17 0 3"
                          stroke="#F59E0B"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                        ...
                        />
                        <path
                          d="M12 6.5c.83-.83 2.17-.83 3 0 1.66 1.66 1.66 4.34 0 6-.83.83-2.17.83-3 0"
                          stroke="#F59E0B"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                        <path
                          d="M17 4.5c.83-.83 2.17-.83 3 0 .83.83.83 2.17 0 3"
                          stroke="#F59E0B"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <p className="mt-1 text-[14px] text-[#666]">
                    Here&apos;s is what&apos;s trending today
                  </p>
                </div>
                <button
                  type="button"
                  ...
                  <div className="flex items-center justify-between bg-[#15152a] px-5 py-3">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex -space-x-2">
                        <span className="grid h-6 w-6 place-items-center rounded-full bg-[#FF6B6B] text-[9px] font-bold text-white ring-2 ring-[#15152a]">
                          A
                        </span>
                        <span className="grid h-6 w-6 place-items-center rounded-full bg-[#4ECDC4] text-[9px] font-bold text-white ring-2 ring-[#15152a]">
                          B
                        </span>
                        <span className="grid h-6 w-6 place-items-center rounded-full bg-[#315BFF] text-[8px] font-bold text-white ring-2 ring-[#15152a]">
                          10K+
                        </span>
                      </div>
                    </div>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="rounded-2xl bg-gradient-to-br from-[#315BFF] to-[#7958FF] p-5 text-white shadow-[0_4px_20px_rgba(49,91,255,0.2)]">
                    ...
                    <p className="mt-1 text-[13px] leading-relaxed text-white/80">
                      we&apos;ve found more projects you might love based on
                      your activity.
                    </p>
              ...
              <section className="mt-8">
                ...
                <p className="mt-1 text-[13px] text-[#666]">
                  Curated projects picked for you
                </p>
              ...
              <div className="mt-8 flex items-center justify-between rounded-xl border border-black/[0.04] bg-white/60 p-4 backdrop-blur-sm">
                <div className="flex items-center gap-4">
                  <div className="flex -space-x-2">
                    <span className="grid h-8 w-8 place-items-center rounded-full bg-[#FF6B6B] text-[10px] font-bold text-white ring-2 ring-white">
                      A
                    </span>
                    <span className="grid h-8 w-8 place-items-center rounded-full bg-[#4ECDC4] text-[10px] font-bold text-white ring-2 ring-white">
                      B
                    </span>
                    <span className="grid h-8 w-8 place-items-center rounded-full bg-[#315BFF] text-[9px] font-bold text-white ring-2 ring-white">
                      10K+
                    </span>
                  </div>
                  <div>
                    ...
                    <p className="text-[12px] text-[#666]">
                      Create an account to save projects, follow developers and
