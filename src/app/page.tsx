...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden text-[#111]" style={{
      background: 'linear-gradient(180deg, #F8F6FF 0%, #F2EEFF 15%, #F0ECFF 30%, #EDE8FF 50%, #E8E0FF 70%, #E4DAFF 100%)'
    }}>
      {/* Background glow */}
      <div className="pointer-events-none fixed inset-0 -z-10" style={{
        background: 'radial-gradient(ellipse 70% 50% at 85% 40%, rgba(100,80,220,0.15) 0%, transparent 70%), radial-gradient(ellipse 50% 40% at 70% 75%, rgba(80,60,220,0.12) 0%, transparent 60%)'
      }} />
      ...
      <nav className="flex items-center justify-between px-6 lg:px-10 py-4 bg-white/40 backdrop-blur-xl border-b border-white/30">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden md:flex items-center gap-2 bg-white/70 border border-white/50 rounded-full px-4 py-2">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#999" strokeWidth="2" strokeLinecap="round"><circle cx="11" cy="11" r="8" /><path d="m21 21-4.35-4.35" /></svg>
            <input
              type="text"
          ...
          <Link href="/login" className="px-5 py-2 text-[13px] font-medium text-[#333] border border-[#ddd] rounded-full hover:bg-white/60 transition-colors">
            Login
          </Link>
          <Link href="/signup" className="px-5 py-2 text-[13px] font-semibold text-white bg-[#315BFF] rounded-full hover:bg-[#2a4de6] transition-colors">
            Sign up
          </Link>
        </div>
      </nav>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[300px_1fr_240px] items-start">
          ...
          <div className="space-y-5">
            <div className="inline-flex items-center gap-1.5 rounded-full bg-[#f0f4ff] px-3 py-1.5">
              ...
              <span className="text-[13px] font-semibold text-[#315BFF]">Product of the day</span>
            </div>
            <div>
              <h2 className="text-[32px] font-bold text-[#111] leading-tight">Hoobank</h2>
            ...
            <div className="flex items-center gap-5 pt-3">
              <span className="flex items-center gap-1.5 text-[15px] font-semibold text-[#555]">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#315BFF" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 19V5M5 12l7-7 7 7" /></svg>
                482
              </span>
          ...
          <div className="relative rounded-2xl overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-5">
              <div className="flex items-center gap-6">
                <div>
                  <span className="text-[18px] font-bold text-white">3800+</span>
                  <span className="text-[11px] text-white/60 ml-1.5">USERS ONLINE</span>
                </div>
                <div>
                  <span className="text-[18px] font-bold text-white">230+</span>
                  <span className="text-[11px] text-white/60 ml-1.5">TRUSTED BY COMPANY</span>
                </div>
                <div>
                  <span className="text-[18px] font-bold text-white">$230M+</span>
                  <span className="text-[11px] text-white/60 ml-1.5">TRANSACTION</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl bg-white/60 backdrop-blur border border-white/40 p-5">
              ...
              <div className="text-[28px] font-bold text-[#111] leading-tight">12K+</div>
              <div className="text-[14px] text-[#888] mt-0.5">projects shipped</div>
            </div>

            {/* Developers */}
            <div className="rounded-2xl bg-white/60 backdrop-blur border border-white/40 p-5">
              <div className="w-11 h-11 rounded-full bg-[#315BFF] flex items-center justify-center mb-3">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M22 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>
              </div>
              <div className="text-[28px] font-bold text-[#111] leading-tight">25K+</div>
            ...
            <div className="rounded-2xl bg-white/60 backdrop-blur border border-white/40 p-5">
              ...
              <div className="text-[28px] font-bold text-[#111] leading-tight">4.8</div>
              <div className="text-[14px] text-[#888] mt-0.5">Average rating</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1 overflow-x-auto">
            {[
              ...
              >
                {tab.icon === 'star' && (
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></svg>
                )}
                {tab.label}
              </button>
            ))}
      ...
      <section className="mx-auto max-w-[1200px] px-6 py-8">
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {/* Large Featured Card */}
          {products.filter(p => p.large).map((product) => (
            <div key={product.id} className="relative overflow-hidden rounded-2xl bg-[#1a1a2e] sm:col-span-2 lg:col-span-2 aspect-[16/9]">
              <Image
                src={product.image}
                alt={product.name}
                fill
          ...
          {products.filter(p => !p.large).map((product) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="mt-1 text-[13px] text-[#555] line-clamp-2">{product.tagline}</p>
                <div className="mt-3 flex items-center justify-between">
                  <span className="text-[12px] text-[#888]">by {product.maker}</span>
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
          ...
          <div className="max-w-[480px]">
            <div className="inline-flex items-center gap-1.5 rounded-full bg-[#f0f4ff] px-3 py-1 mb-5">
              <span className="text-[12px] font-medium text-[#315BFF]">♧ Join the community</span>
              <div className="flex -space-x-1.5">
                {communityAvatars.map((a, i) => (
                  <div key={i} className="w-4 h-4 rounded-full border border-white overflow-hidden">
                    <Image src={a} alt="" width={16} height={16} className="w-full h-full object-cover" />
                  </div>
                ))}
              </div>
            </div>
            ...
            <p className="mt-4 text-[15px] text-[#555] leading-relaxed">
              Save your favorite projects, follow developers,<br />
      ...
      <footer className="border-t border-white/30 bg-white/30 backdrop-blur-xl">
        <div className="mx-auto max-w-[1200px] px-6 py-14">
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1.5fr_1fr_1fr_1fr_1fr]">
            ...
            <div className="max-w-[260px]">
              ...
              <p className="text-[12px] text-[#888] leading-relaxed mb-5">
                Scouts is the home for innovative<br />
                projects and the people behind them.<br />
                Build in public. Get discovered.
              </p>
              <Link href="/signup" className="inline-flex items-center gap-1 text-[13px] font-semibold text-[#315BFF] hover:underline">
                Join Scouts →
              </Link>
            </div>
            ...
            {[
              ...
              <div key={col.title}>
                <h4 className="text-[11px] font-bold tracking-wider text-[#888] mb-4">{col.title}</h4>
                <ul className="space-y-2.5">
                  {col.links.map((link) => (
                    <li key={link}>
                      <Link href="#" className="text-[13px] text-[#555] hover:text-[#111] transition-colors">
                        {link}
                      </Link>
                    </li>
                  ))}
          ...
          <div className="mt-12 flex items-center justify-between border-t border-white/30 pt-6">
            <div className="flex items-center gap-4">
              {/* GitHub */}
              <a href="#" className="text-[#888] hover:text-[#111] transition-colors">
