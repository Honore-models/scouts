...
const trendingProducts = [
  { id: '1', name: 'FlowBoard', tagline: 'AI powered whiteboard for collaborative teams', maker: 'David Kim', image: '/landing/dashboard-tilt.png', upvotes: 1240, comments: 89, rating: 4.9, rank: 1, category: 'SaaS' },
  { id: '2', name: 'DeliciousFood', tagline: 'All in one platform that helps restaurants grow from dashboard to doorstep', maker: 'Ivan', image: '/landing/delicious.png', upvotes: 987, comments: 64, rating: 4.8, rank: 2, category: 'Web Apps' },
  { id: '3', name: 'CodeSnap', tagline: 'Beautiful code screenshots in one click', maker: 'Cenat', image: '/landing/code.png', upvotes: 856, comments: 52, rating: 4.7, rank: 3, category: 'Developer tools' },
  { id: '4', name: 'Kartz', tagline: 'Art Selling website for independent artists', maker: 'Mandrake', image: '/landing/kartz.png', upvotes: 743, comments: 41, rating: 4.6, rank: 4, category: 'Marketplace' },
  { id: '5', name: 'ShipFast', tagline: 'Ship your MVP in days not months', maker: 'Liam Chen', image: '/landing/code.png', upvotes: 621, comments: 38, rating: 4.5, rank: 5, category: 'Developer tools' },
  { id: '6', name: 'MindMap AI', tagline: 'AI powered mind mapping and brainstorming', maker: 'Alex Park', image: '/landing/delicious.png', upvotes: 534, comments: 29, rating: 4.4, rank: 6, category: 'AI' },
  { id: '7', name: 'LandingKit', tagline: 'Beautiful landing page templates for startups', maker: 'Sara Kim', image: '/landing/kartz.png', upvotes: 412, comments: 22, rating: 4.3, rank: 7, category: 'Design' },
  { id: '8', name: 'DataPulse', tagline: 'Real time analytics dashboard for SaaS products', maker: 'Mike Ross', image: '/landing/code.png', upvotes: 389, comments: 18, rating: 4.2, rank: 8, category: 'SaaS' },
  { id: '9', name: 'PixelForge', tagline: 'AI image generation and editing platform', maker: 'Emma Wilson', image: '/landing/delicious.png', upvotes: 367, comments: 15, rating: 4.1, rank: 9, category: 'AI' },
];
          ...
          <main className="px-6 py-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-[14px] text-[#666]">The most popular projects right now</p>
              </div>
            </div>
            ...
            <div className="mt-5 flex items-center gap-1.5 overflow-x-auto">
              {timeFilters.map((filter) => {
                ...
                return (
                  <button key={filter.id} type="button" onClick={() => setActiveFilter(filter.id)} className={`flex shrink-0 items-center gap-1.5 rounded-lg px-4 py-2 text-[13px] font-medium transition-colors duration-150 ${activeFilter === filter.id ? 'bg-[#315BFF] text-white shadow-[0_2px_8px_rgba(49,91,255,0.25)]' : 'bg-white/60 text-[#555] hover:bg-white hover:text-[#111]'}`}>
            ...
            <div className="mt-6 space-y-3">
              {trendingProducts.map((product) => (
                <Link key={product.id} href={`/product/${product.id}`} className="group flex items-center gap-4 rounded-xl bg-white/60 p-4 backdrop-blur-sm transition-all duration-200 hover:bg-white hover:shadow-[0_4px_16px_rgba(0,0,0,0.06)]">
                  {/* Rank */}
                  <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl text-[16px] font-bold ${product.rank <= 3 ? 'bg-[#315BFF] text-white' : 'bg-[#F3F4F6] text-[#666]'}`}>
                    {product.rank}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="mt-1 text-[12px] text-[#999]">by {product.maker}</p>
                  </div>
